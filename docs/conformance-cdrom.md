...
Measured against `TOSHIBA  CD-ROM XM-5201TA 3254  CD-ROM, removable`.
...
| `0x1c RECEIVE DIAGNOSTIC RESULTS` | executed |
| `0x25 READ CAPACITY(10)` | executed |
| `0x28 READ(10)` | executed |
| `0x2f VERIFY(10)` | executed |
| `0xa8 READ(12)` | executed |
| `0x43 READ TOC` | executed |
| `0x42 READ SUB-CHANNEL` | executed |
...
| limit | why |
|---|---|
| `0x34 PRE-FETCH(10)` | odd status: status 0x04 |
| `0xff vendor-reserved opcode 0xFF` | ADAPTER HUNG |
...
|---|---|---|
| `0x1d SEND DIAGNOSTIC` | SCSI-2 mandatory | refused: illegal request (key 0x05, asc 0x1a, ascq 0x00) |
| `0x35 SYNCHRONIZE CACHE(10)` | SCSI-2 optional | refused: invalid opcode (illegal request (key 0x05, asc 0x20, ascq 0x00)) |
| `0x37 READ DEFECT DATA(10)` | SCSI-2 optional | refused: invalid opcode (illegal request (key 0x05, asc 0x20, ascq 0x00)) |
| `0x3c READ BUFFER` | SCSI-2 optional | refused: illegal request (key 0x05, asc 0x2c, ascq 0x00) |
